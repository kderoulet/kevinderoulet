    ...
    return(
        <div className='container'>
            ...
            <Link to='/portfolio'><img className='img-fluid' src={chess} alt='chess project' style={{maxWidth: 500}}></img></Link>
                ...
                <br/>
                <p><a style={{backgroundColor: "#2687FB", color: "#FFFFFF", padding: 20, borderRadius: "5%"}} href='https://chessforreact.herokuapp.com/' target='_blank' rel='noopener noreferrer'>Check Out the App</a> &nbsp;&nbsp;&nbsp;&nbsp;
                <a style={{backgroundColor: "#2687FB", color: "#FFFFFF", padding: 20, borderRadius: "5%"}} href='https://github.com/kderoulet/react-chess' target='_blank' rel='noopener noreferrer'>Check Out the Github</a></p>
        </div>
    )
}
